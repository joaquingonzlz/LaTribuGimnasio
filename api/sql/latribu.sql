DROP DATABASE `u464982645_latribu`;
SET AUTOCOMMIT = 0;
START TRANSACTION;
SET time_zone = "-03:00";
SET lc_time_names = "es_AR";
CREATE DATABASE IF NOT EXISTS `u464982645_latribu` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `u464982645_latribu`;
